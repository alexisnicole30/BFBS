...
$sql = "SELECT prod_id, prod_name, prod_image, prod_origPrice, prod_discountPrice, prod_qoh, category_name FROM product WHERE prod_qoh > 0";
...
<body>
    ...
    <script>
            ...
            products.forEach(product => {
                ...
                productContainer.innerHTML = `
                    ...
                    <div class="product-details">
                        ...
                        <p class="discounted-price">$${(product.prod_origPrice - product.prod_discountPrice).toFixed(2)}</p>
        ...
        function updateQuantity(productId, change) {
            ...
            const maxQuantity = parseInt(productContainer.dataset.maxQuantity, 10);

            quantity = Math.max(0, Math.min(quantity + change, maxQuantity));
            quantityElement.textContent = quantity;

            // Remove product container if quantity is zero
            if (quantity === 0) {
                if (productContainer) {
