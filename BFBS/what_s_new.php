...
<header class ="header">
    <div class="top_inner">
        <div class="navigation">
            ...
            <div class="right_icons">
                ...
                <a href="./favoritePage.html" class="navigation_links">
                    <div>
    ...
    <div class="navigation2">
        <a href="./what_s_new.html" class="navigation_links">What's New</a>
        <a href="#section2" class="navigation_links">Sales</a>
        <a href="#section4" class="navigation_links">Occasion</a>
        <a href="./customization.html" class="navigation_links">Customization</a>
    </div>
